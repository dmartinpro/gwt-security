...
/**
 * A DefaultLoginPageGeneratingFilter copy to support a GWT based form login
 * @author dmartin
 *
 */
public class GwtLoginFilter extends GenericFilterBean {
    public static final String DEFAULT_LOGIN_PAGE_URL = "/spring_security_gwt_login";
    ...
    public GwtLoginFilter(AbstractAuthenticationProcessingFilter filter) {
    ...
    public GwtLoginFilter(UsernamePasswordAuthenticationFilter authFilter, AbstractAuthenticationProcessingFilter openIDFilter) {
